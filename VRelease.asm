...
v4ecartversion      fdb      $0001                        ; I always have a version 
                                                          ; in comm. structs 
	if VECFEVER
v4ecartflags        fdb      $68e0                        ; v4e flags: 
	else
...
title_main_go 
	...
	if VECFEVER = 1
					ldb		v4ecartflags
					bpl		title_not_v4e_menu_score_display
					bitb	#$08
					bne		title_not_v4e_menu_score_display
                    jsr      clear_all_sound 
                    jmp		display_highscore
title_not_v4e_menu_score_display
	endif
backFromDemo 
...
; everything is faster than "jsr random"
	...
	if VECFEVER = 1
					tst		v4ecartflags
					bpl		getButtonState_not_v4e
					pshs	x
					ldx		led_data_pointer
					lda		,x+
					bmi		led_no_write
					cmpa	#LED_REPEAT_3
					bne		led_no_repeat
					...
					lda		-1,x
led_no_repeat
					stx		led_data_pointer
					sta		$7ffe
led_no_write		puls	x
getButtonState_not_v4e
	endif
...
led_data_pointer	fdb		led_off
led_game_over_explosion		fcb		RED,RED,MAGENTA,LED_REPEAT_3
led_game_over		fcb		RED,-1
led_score_display	fcb		WHITE,WHITE,CYAN
led_off				fcb		0,-1
	endif
...
add_score_x                                               ;#isfunction  
	...
	if VECFEVER = 1
					tst		v4ecartflags
					bpl		add_score_x_not_v4e
					ldd		#led_score_display
