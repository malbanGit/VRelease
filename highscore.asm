...
display_highscore_intern 
	...
	if VECFEVER = 0
					...
					lda		 v4ecartflags
					bpl		 display_highscore_not_v4e
					bita	 #8							  ; menu highscore entry ?
					bne      display_highscore_not_v4e	  ; nope
                    jsr      Wait_Recal 
                    ldx      RecalCounter                 ; recal counter, about 21 Minutes befor roll over 
                    leax     1,x 
                    stx      RecalCounter
					cmpx	 #50*30
					lbeq	 goback
					bra		 display_highscore_v4e
display_highscore_not_v4e
                    jsr      PLY_PLAY 
                    tst      songOver 
                    lbne     return_to_title 
                    jsr      Wait_Recal 
...
; player_score
	...
	if VECFEVER = 1
					ldb		v4ecartflags
					bitb	#$08
					bne		not_v4e_menu_hiscore_display
					bita	#1
					lbeq	goback
					bra		display_highscore_intern2
not_v4e_menu_hiscore_display
	endif
