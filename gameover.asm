...
;
                    org      END_RAM_START 
gameOverCounter1    ds       1 
gameOverIntensity   ds       1 
; 3d vars and general "explosion" vars use the same RAM space,
; they are never used at the same time - so no collision here
;
                    INCLUDE  "3d/3D_VAR.I"                ; RAM locations reused
                    org      END_RAM_START 
;
; var definitions used in the game over sequence
spinSpeed_all       ds       2 
spawnDelay          ds       1 
...
; sound in all three channels -> is more impressive!
	...
	if VECFEVER = 1
					tst		v4ecartflags
					bpl		mainGameOver
					ldd		#led_game_over_explosion
					std		led_data_pointer
	endif
mainGameOver:                                             ;#isfunction  
                    _ZERO_VECTOR_BEAM  
                    jsr      getButtonState               ; is a button pressed? 
                    tsta     
                    lbeq     do3dGameOver_buttons         ;allFourButtonsPressed_return 
                    jsr      Wait_Recal 
                    tst      sfxOption 
...
INIT_3D_LETTER      macro    _vlist_3d, _pos_3d_, _offset_3d_ 
                    ...
                    endm     
INIT_3D_LETTER_L    macro    _vlist_3d, _pos_3d_, _offset_3d_ 
                    ldy      #($f*256) +_offset_3d_ 
                    ldx      #_vlist_3d 
                    ldd      #_pos_3d_ 
                    jsr      init_3d_letter_jsr 
                    endm     
init_3d_letter_jsr 
                    sty      s_scale_3d,u 
                    stx      s_vlist_3d,u 
...
;
do3dGameOver                                              ;#isfunction  
mainGameOver3d:                                           ;#isfunction  
                    ldb      #0 
                    stb      last_button_state 
                    stb      current_button_state 
do3dGameOver_buttons 
	if VECFEVER = 1
					tst		v4ecartflags
					bpl		do3dGameOver_buttons_not_v4e
					ldd		#led_game_over
					std		led_data_pointer
do3dGameOver_buttons_not_v4e
	endif
...
;
                    ...
                    INIT_3D_LETTER_L  e_3d, $2050-4, 42 
                    INIT_3D_LETTER_L  r_3d, $2070-6, 49 
                    ldd      #0 
                    std      s_vlist_3d,u 
                    sta      scale_3d_move 
                    ...
                    stb      return_state 
DECREASE            =        5 
                    sta      gameOverIntensity 
                    lda      #DECREASE 
                    sta      gameOverCounter1 
mainGameOver3dLoop: 
                    _ZERO_VECTOR_BEAM  
                    jsr      getButtonState               ; is a button pressed? 
                    lbne     doreturn 
...
not_higher_scale 
                    lda      gameOverIntensity 
                    dec      gameOverCounter1 
                    bne      notMaxScale 
                    ldb      #DECREASE 
                    stb      gameOverCounter1 
                    dec      gameOverIntensity 
notMaxScale 
                    JSR      Intensity_a 
                    ldy      #letters_3d 
another_letter 
